       ...
       <div class="row gx-4 gx-lg-5 align-items-center">
           <?php foreach($weapons as $weapon) : ?>
            ...
            <?php if (array_key_exists('id', $weapon) && $weapon['id']['id'] == $ID ): ?>
               <div class="col-md-6">
                   <?php echo '<td><img class="card-img-top mb-5 mb-md-0 shadow"
               ...
               <div class="col-md-6">
                   ...
                   <?php echo '<td><h1 class="display-5 fw-bolder">'.$weapon['name'] .'</h1></td>'?>
                   ...
                   <?php echo '<td><p>
                        ...
                        Composition: '.$weapon["composition"] .'</p></td>'?>

                   <?php if (array_key_exists('enable', $weapon)&& $weapon['enable']){
                       echo '<td><button class="btn btn-outline-dark mt-1" type="button">
                       ...
                       echo '<td><button class="btn btn-danger mt-1" type="button">
                       <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-cart mb-1 me-1" viewBox="0 0 16 16">
                           <path d="M0 1.5A.5.5 0 0 1 .5 1H2a.5.5 0 0 1 .485.379L2.89 3H14.5a.5.5 0 0 1 .491.592l-1.5 8A.5.5 0 0 1 13 12H4a.5.5 0 0 1-.491-.408L2.01 3.607 1.61 2H.5a.5.5 0 0 1-.5-.5zM3.102 4l1.313 7h8.17l1.313-7H3.102zM5 12a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm7 0a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm-7 1a1 1 0 1 1 0 2 1 1 0 0 1 0-2zm7 0a1 1 0 1 1 0 2 1 1 0 0 1 0-2z"/>
                       </svg>
                       Not Available
        ...
        <div class="row gx-4 gx-lg-5 align-items-center">
            <div class="col mb-5">
                <div class="card h-100">
                    <?php echo '<td><a href="product.php?'.http_build_query($weapons[1]['id']).'">
                        <img class="card-img-top border"
                         src="../images/'.$weapons[1]["image"].'"
                         width="auto" height="auto"/></a></td>'?>
                    <div class="ribbon ribbon-top-left"><span><?php echo $weapons[1]['promo'] ?>% Off </span></div>
                    <div class="card-body p-4">
                        <div class="text-center">
                            <?php echo '<td><h5 class="fw-bolder">'.$weapons[1]['name'] .'</h5></td>'?>
            ...
            <div class="col mb-5">
                <div class="card h-100">
                    <?php echo '<td><a href="product.php?'.http_build_query($weapons[4]['id']).'">
                        <img class="card-img-top border"
                         src="../images/'.$weapons[4]["image"].'"
                         width="auto" height="auto"/></a></td>'?>
                    <div class="card-body p-4">
                        <div class="text-center">
                            <?php echo '<td><h5 class="fw-bolder">'.$weapons[4]['name'] .'</h5></td>'?>
            ...
            <div class="col mb-5">
                <div class="card h-100">
                    <?php echo '<td><a href="product.php?'.http_build_query($weapons[5]['id']).'">
                        <img class="card-img-top border"
                         src="../images/'.$weapons[5]["image"].'"
                         width="auto" height="auto"/></a></td>'?>
                    <div class="card-body p-4">
                        <div class="text-center">
                            <?php echo '<td><h5 class="fw-bolder">'.$weapons[5]['name'] .'</h5></td>'?>
            ...
            <div class="col mb-5">
                <div class="card h-100">
                    <?php echo '<td><a href="product.php?'.http_build_query($weapons[6]['id']).'">
                        <img class="card-img-top border"
                         src="../images/'.$weapons[6]["image"].'"
                         width="auto" height="auto"/></a></td>'?>
                    <div class="card-body p-4">
                        <div class="text-center">
                            <?php echo '<td><h5 class="fw-bolder">'.$weapons[6]['name'] .'</h5></td>'?>
                            <span><?php echo  '$'. $weapons[5]['price']; ?></span>
                        </div>
                    </div>
                </div>
